...
export default function FruitMarketLevel() {
  ...
  const difficulty = zoneDifficulties["fruitMarket"] || 'easy';
  const learnerState = zoneLearnerStates["fruitMarket"] || { skillLevel: 10, recentSuccessStreak: 0, recentFailureStreak: 0 };
  ...
  return (
    <div className="flex-1 w-full relative">
      ...
      <GameShell
        ...
        backHref="/elementary/fruit-market"
        title="Fruit Market"
        levelNum={levelNum}
      ...
      {gamePhase === "complete" && (
        <LevelComplete
          ...
          onNext={() => router.push(`/elementary/fruit-market/${levelNum + 1}`)}
          onRetry={() => {
            // Reset level state
            setCurrentRound(0);
            setGamePhase("playing");
