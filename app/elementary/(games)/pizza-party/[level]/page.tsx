...
export default function PizzaPartyLevel() {
  ...
  const difficulty = zoneDifficulties["pizzaParty"] || 'easy';
  const learnerState = zoneLearnerStates["pizzaParty"] || { skillLevel: 10, recentSuccessStreak: 0, recentFailureStreak: 0 };
  ...
  return (
    <div className="flex-1 w-full relative">
      ...
      <GameShell
        ...
        backHref="/elementary/pizza-party"
        title="Pizza Party"
        levelNum={levelNum}
