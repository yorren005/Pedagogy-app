...
export default function PicnicLevel() {
  ...
  const difficulty = zoneDifficulties["picnic"] || 'easy';
  const learnerState = zoneLearnerStates["picnic"] || { skillLevel: 10, recentSuccessStreak: 0, recentFailureStreak: 0 };
  ...
  return (
    <div className="flex-1 w-full relative">
      ...
      <GameShell
        ...
        backHref="/elementary/the-picnic"
        title="The Picnic"
        levelNum={levelNum}
