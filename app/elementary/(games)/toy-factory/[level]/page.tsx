...
export default function ToyFactoryLevel() {
  ...
  const difficulty = zoneDifficulties["toyFactory"] || 'easy';
  const learnerState = zoneLearnerStates["toyFactory"] || { skillLevel: 10, recentSuccessStreak: 0, recentFailureStreak: 0 };
  ...
  return (
    <div className="flex-1 w-full relative">
      ...
      <GameShell
        ...
        backHref="/elementary/toy-factory"
        title="Toy Factory"
        levelNum={levelNum}
