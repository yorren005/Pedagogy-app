...
export default function WordSafariLevel() {
  ...
  const difficulty = zoneDifficulties["wordSafari"] || 'easy';
  const learnerState = zoneLearnerStates["wordSafari"] || { skillLevel: 10, recentSuccessStreak: 0, recentFailureStreak: 0 };
  ...
  return (
    <div className="flex-1 w-full relative">
      ...
      <GameShell
        ...
        backHref="/elementary/word-safari"
        title="Word Safari"
        levelNum={levelNum}
